...
CREATE TABLE `respondidas` (
  `id_respondida` int NOT NULL AUTO_INCREMENT,
  `id_usuario` int NOT NULL,
  `id_pregunta` int NOT NULL,
  `respuesta` tinyint(1) NOT NULL,
  PRIMARY KEY (`id_respondida`),
  KEY `id_usuario` (`id_usuario`),
  KEY `id_pregunta` (`id_pregunta`),
  CONSTRAINT `respondidas_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `respondidas_ibfk_2` FOREIGN KEY (`id_pregunta`) REFERENCES `preguntas` (`id_pregunta`)
...
-- Dump completed on 2021-09-27 14:02:19
